...
export class MascotaService {
  ...
  agregarMascota(mascota: MascotaModel){
    ...
    return this.http.post<MascotaModel>(`${this.BASE_URL}/mascotas/crear`, mascota);
  }

  //actualizar mascota
  actualizarMascota(mascota: MascotaModel){
    return this.http.put<MascotaModel>(`${this.BASE_URL}/mascotas/editar/${mascota.id}`,mascota );
  }

  //borrar mascota
  borrarMascota(idMascota: string){
    return this.http.delete(`${this.BASE_URL}/mascotas/eliminar/${idMascota}`);
  }
